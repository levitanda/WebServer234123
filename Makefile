...
#
OBJS = server.o request.o segel.o client.o struct.o
TARGET = server
...
server: server.o request.o segel.o struct.o
	$(CC) $(CFLAGS) -o server server.o request.o segel.o struct.o $(LIBS)
